...
test("defines the three v1.2.3 GitHub Release assets", () => {
  assert.equal(RELEASE_VERSION, "1.2.3");
  assert.deepEqual(RELEASE_ASSETS, {
    userscript: "yang-bnbu-course-assistant.user.js",
    archive: "yang-bnbu-course-assistant-v1.2.3.zip",
    checksums: "SHA256SUMS.txt"
  });
});

test("accepts the source bundle allowlist and rejects private or generated paths", () => {
  const root = "yang-bnbu-course-assistant-v1.2.3/";
